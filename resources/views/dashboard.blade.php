                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress" style="height: 10px;">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{ ($serverStatusStats['online'] / max(1, $serverCount)) * 100 }}%"></div>
                                        </div>
                                        <small class="text-muted">{{ $serverStatusStats['online'] }}/{{ $serverCount }} 在线</small>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">{{ $taskCount ?? 0 }} 个任务</small>
                                    </td>
                                </tr>
                                <tr>
