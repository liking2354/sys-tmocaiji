                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">{{ $serverCount }}</h2>
                        </div>
                        <i class="fas fa-server fa-3x opacity-50"></i>
                    </div>
                </div>
                <div class="card-footer d-flex justify-content-between">
                    <span>在线: {{ $serverStatusStats['online'] }}</span>
                    <span>离线: {{ $serverStatusStats['offline'] }}</span>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">{{ $groupCount }}</h2>
                        </div>
                        <i class="fas fa-layer-group fa-3x opacity-50"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('server-groups.index') }}" class="text-white">查看所有分组</a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">{{ $collectorCount }}</h2>
                        </div>
                        <i class="fas fa-plug fa-3x opacity-50"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('collectors.index') }}" class="text-white">查看所有组件</a>
                </div>
            </div>
        </div>
