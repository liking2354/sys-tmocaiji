...
#addRuleModal .list-group-item:hover {
    background-color: rgba(var(--primary-color-rgb), 0.08);
    transform: translateX(4px);
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);
}

#addRuleModal .list-group-item h6 {
    font-weight: 600;
    color: var(--text-primary);
}

#addRuleModal .modal-body {
    padding: 20px;
}

#addRuleModal .list-group {
    margin: -5px;
}
</style>
@endsection
...
<div class="container-fluid">
    ...
    <div class="mb-4">
        <h1 class="mb-1">
            <i class="fas fa-edit text-primary"></i> 编辑配置模板 - {{ $template->name }}
        </h1>
        <p class="text-muted">使用可视化界面修改系统变更模板</p>
    </div>
