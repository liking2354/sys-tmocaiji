            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <span>权限管理</span>
                        <a href="{{ route('admin.permissions.create') }}" class="btn btn-primary btn-sm">添加权限</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.permissions.edit', $permission->id) }}" class="btn btn-sm btn-info">编辑</a>
