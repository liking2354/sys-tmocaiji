<?php $__env->startSection('title', '仪表盘 - TMO云迁移'); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($serverCount); ?></div>
                            <div class="mt-2 text-xs">
                                <span class="text-success mr-2"><i class="fas fa-circle"></i> 在线: <?php echo e($serverStatusStats['online']); ?></span>
                                <span class="text-danger"><i class="fas fa-circle"></i> 离线: <?php echo e($serverStatusStats['offline']); ?></span>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('servers.index')); ?>" class="btn btn-sm btn-primary btn-block">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($groupCount); ?></div>
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('server-groups.index')); ?>" class="btn btn-sm btn-success btn-block">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($collectorCount); ?></div>
                            <div class="mt-2 text-xs text-gray-600">
                                用于数据采集的可用组件
                            </div>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('collectors.index')); ?>" class="btn btn-sm btn-info btn-block">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($taskCount ?? 0); ?></div>
                            <div class="mt-2 text-xs text-gray-600">
                                数据采集任务管理
                            </div>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('collection-tasks.index')); ?>" class="btn btn-sm btn-warning btn-block">
