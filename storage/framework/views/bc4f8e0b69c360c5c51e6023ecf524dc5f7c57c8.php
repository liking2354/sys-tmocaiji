                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h2 mb-0 font-weight-bold"><?php echo e($serverCount); ?></div>
                            <div class="mt-3 small">
                                <span class="badge badge-success mr-2">
                                    <i class="fas fa-circle"></i> 在线: <?php echo e($serverStatusStats['online']); ?>

                                </span>
                                <span class="badge badge-danger">
                                    <i class="fas fa-circle"></i> 离线: <?php echo e($serverStatusStats['offline']); ?>
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('servers.index')); ?>" class="btn btn-primary btn-sm btn-block">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h2 mb-0 font-weight-bold"><?php echo e($groupCount); ?></div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h2 mb-0 font-weight-bold"><?php echo e($collectorCount); ?></div>
                            <div class="mt-3 small text-muted">
                                用于数据采集的可用组件
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h2 mb-0 font-weight-bold"><?php echo e($taskCount ?? 0); ?></div>
                            <div class="mt-3 small text-muted">
                                数据采集任务管理
                            </div>
                        </div>
