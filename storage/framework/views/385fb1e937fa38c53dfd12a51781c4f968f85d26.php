<?php $__env->startSection('title', ($task->name ?? '未知任务') . ' - 采集任务详情'); ?>
...
<?php if(!$task): ?>
    <div class="container-fluid">
        <div class="alert alert-danger">
            <h4>错误</h4>
            <p>任务不存在或已被删除。</p>
            <a href="<?php echo e(route('collection-tasks.index')); ?>" class="btn btn-primary">返回任务列表</a>
        </div>
    </div>
<?php else: ?>
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>任务描述:</th>
                            <td><?php echo e($task->description ?: '无描述'); ?></td>
                        </tr>
                        <tr>
                            <th>任务类型:</th>
                            <td>
                ...
                <div class="col-md-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>创建时间:</th>
                            <td><?php echo e($task->created_at ? $task->created_at->format('Y-m-d H:i:s') : '未知'); ?></td>
                        </tr>
                        <tr>
                            <th>开始时间:</th>
                        ...
                        <tr>
                            ...
                            <td id="durationDisplay">
                                ...
                                <?php elseif($task->started_at): ?>
                                    <?php echo e($task->started_at->diffForHumans()); ?>
                    ...
                    <tbody id="detailsTableBody">
                        <?php $__empty_1 = true; $__currentLoopData = $detailsByServer->flatten()->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-status="<?php echo e($detail->status); ?>" data-detail-id="<?php echo e($detail->id); ?>">
                                ...
                                <td>
                                    <span class="badge badge-<?php echo e($detail->collector->type === 'script' ? 'info' : 'warning'); ?>">
                                        <?php echo e($detail->collector->name); ?>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <?php if($detail->isFailed() && $detail->error_message): ?>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="viewError('<?php echo e($detail->id); ?>', '<?php echo e(addslashes($detail->error_message)); ?>')">
                                            <i class="fas fa-exclamation-triangle"></i> 查看错误
                                        </button>
                                    <?php endif; ?>
                                    <?php if(in_array($detail->status, [3, 4])): ?> 
                                        <button type="button" class="btn btn-sm btn-warning" onclick="retryTaskDetail('<?php echo e($detail->id); ?>')">
