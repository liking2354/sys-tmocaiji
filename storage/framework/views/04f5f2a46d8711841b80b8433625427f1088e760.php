...
unset($__errorArgs, $__bag); ?>" name="username" value="<?php echo e(old('username', $user->username)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="status" required>
                                    <option value="1" <?php echo e(old('status', $user->status) == 1 ? 'selected' : ''); ?>>启用</option>
                                    <option value="0" <?php echo e(old('status', $user->status) == 0 ? 'selected' : ''); ?>>禁用</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e($role->id); ?>" id="role-<?php echo e($role->id); ?>" <?php echo e(in_array($role->id, $userRoles) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tanli/Documents/php-code/sys-tmocaiji/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>