<?php $__env->startSection('title', '添加服务器 - 服务器管理与数据采集系统'); ?>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('servers.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="group_id" name="group_id" required>
                                ...
                                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($group->id); ?>" <?php echo e(old('group_id', request('group_id')) == $group->id ? 'selected' : ''); ?>><?php echo e($group->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="ip" name="ip" value="<?php echo e(old('ip')); ?>" required>
                            <?php $__errorArgs = ['ip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="port" name="port" value="<?php echo e(old('port', 22)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="verify_connection" name="verify_connection" value="1" <?php echo e(old('verify_connection', '1') ? 'checked' : ''); ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $collectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="collector_<?php echo e($collector->id); ?>" name="collectors[]" value="<?php echo e($collector->id); ?>" <?php echo e(in_array($collector->id, old('collectors', [])) ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tanli/Documents/php-code/sys-tmocaiji/resources/views/servers/create.blade.php ENDPATH**/ ?>