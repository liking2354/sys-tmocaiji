<?php $__env->startSection('title', '编辑采集组件 - 服务器管理与数据采集系统'); ?>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('collectors.update', $collector)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name', $collector->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="code" name="code" value="<?php echo e(old('code', $collector->code)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="version" name="version" value="<?php echo e(old('version', $collector->version ?: '1.0.0')); ?>" placeholder="例如：1.0.0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="type_script" name="type" value="script" class="custom-control-input" <?php echo e(old('type', $collector->type) == 'script' ? 'checked' : ''); ?> required>
                                <label class="custom-control-label" for="type_script">脚本类</label>
                                <small class="form-text text-muted">直接执行脚本，无需安装</small>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="type_program" name="type" value="program" class="custom-control-input" <?php echo e(old('type', $collector->type) == 'program' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" id="program_file" name="program_file">
                        ...
                        <?php if($collector->file_path): ?>
                            <div class="mt-2 alert alert-info">
                                <i class="fas fa-info-circle"></i> 当前已上传文件：<?php echo e(basename($collector->file_path)); ?>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="2"><?php echo e(old('description', $collector->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="script_content" name="script_content" rows="15"><?php echo e(old('script_content', $collector->getScriptContent())); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>状态</label>
                    <div class="custom-control custom-radio">
                        <input type="radio" id="status_1" name="status" value="1" class="custom-control-input" <?php echo e(old('status', $collector->status) == 1 ? 'checked' : ''); ?>>
                        <label class="custom-control-label" for="status_1">启用</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" id="status_0" name="status" value="0" class="custom-control-input" <?php echo e(old('status', $collector->status) == 0 ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-check mb-3">
                    <input type="checkbox" class="form-check-input" id="update_servers" name="update_servers" value="1" <?php echo e(old('update_servers') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tanli/Documents/php-code/sys-tmocaiji/resources/views/collectors/edit.blade.php ENDPATH**/ ?>