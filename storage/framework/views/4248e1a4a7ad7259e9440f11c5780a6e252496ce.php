            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <span>添加权限</span>
                        <a href="<?php echo e(route('admin.permissions.index')); ?>" class="btn btn-secondary btn-sm">返回列表</a>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="slug" value="<?php echo e(old('slug')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input id="module" type="text" class="form-control <?php $__errorArgs = ['module'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="module" value="<?php echo e(old('module')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tanli/Documents/php-code/sys-tmocaiji/resources/views/admin/permissions/create.blade.php ENDPATH**/ ?>